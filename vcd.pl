...
$flag[3] = 0;		#change freq range
$flag[4] = 1;		#optimize gamma
$flag[5] = 1;		#optimize scale factor
...
sub write_output{
	...
	close OUT; 
	print "Output file $output made in current directory\n";
}
